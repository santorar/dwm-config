...
static const char *fonts[]          = { "UbuntuMono Nerd Font:size=12", "NotoColorEmoji:pixelsize=11:antialias=true:autohint=true"  };
...
const char *spcmd3[] = {"st", "-n", "sptemr", "-g", "120x34","-e","ncspot", NULL };
